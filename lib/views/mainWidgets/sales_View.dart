                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                          title: const Center(child: Text('توصيل طلبية')),
                          content: SizedBox(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      'اضافة منتج',
                      style: TextStyle(
                          color: maincolor, fontWeight: FontWeight.bold,fontFamily: 'main'),
                    ),
                  ),
                ),
                Container(
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    margin: const EdgeInsets.only(top: 10, bottom: 18, left: 40),
                    child: const Text(
                      'فاتورة المبيع  ',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                  ...
                  Container(
                    margin: const EdgeInsets.only(top: 8, bottom: 18, right: 20),
